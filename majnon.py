...
\x1b[1;97m --------------------------------------------------
 ...
 Author By : MAJNON AFG 🔥 

\x1b[1;97m Facebook : https://www.facebook.com/gohar.shah.566790

\x1b[1;97m Group : BEST THICHNICALS ☆ ✓

\x1b[1;97m Github : MAJNONKING

 \x1b[1;97mWatsapp : 0749322380
 
\x1b[1;97m--------------------------------------------------

\x1b[1;97m  @ Our duty is to provide the best Commands for you ✓ Majnon 🔥
	...
	try:
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[MAJNON-OK] '+cid+' | '+ps)
				...
				print('\r\033[1;31m[MAJNON-CP] '+cid+' | '+ps)
		...
		sys.stdout.write(f"\r\x1b[1;32m[ NAJNON ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}] ")
...
def rcrack(uid,pwx,tl):
	...
	try:
		...
		sys.stdout.write(f"\r \x1b[1;32m[ MAJNON ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}]  ")
